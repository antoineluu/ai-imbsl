...
def replace_cell_names_with_id(dataframe, mapping_file="data/mappingccl.csv", cell_col="cell_line"):
    ...
    dataframe[:,cell_col] = dataframe[:,cell_col].map(alias2id)
    return dataframe
